...
# PAGE 2: MAIN STRATEGIC INFRASTRUCTURE CONTROL DASHBOARD
    ...
    with col3:
        ...
        st.markdown(f'<div class="kpi-card"><div class="kpi-title">🔥 Apex Network Peak Traffic Load</div><div class="kpi-value">{peak_hour:02d}:00 - {peak_hour+1:02d}:00</div><div class="kpi-delta">⏰ Highest Request Phase</div></div>', unsafe_allow_html=True)
